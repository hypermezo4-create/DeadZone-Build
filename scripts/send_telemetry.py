...
def main(argv: list[str] | None = None) -> int:
    ...
    # Direct GitHub/manual builds have no control-bot request to update. Their
    # project notify.py still provides the live user-facing build message.
    if not secret or os.environ.get("DEADZONE_CONTROLLED_BUILD", "0") != "1":
        return 0
    ...
    try:
        ...
        print(f"[DeadZone System] telemetry deferred: {exc}")
        return 1
    return 0
